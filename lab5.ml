...
let mappend (m1 : 'a mlist) (m2 : 'a mlist) =
  let rec mlistappend (m1 : 'a mlist) (m2 : 'a mlist) =
    match m1 with
    | Nil -> m2
    | Cons (a, b) -> Cons (a, ref (mlistappend !b m2))
  in
  m1 := mlistappend m1 m2;;


let rec mappend (m1 : 'a mlist) (m2 : 'a mlist) =
  try
    match m1 with
    | Nil -> raise Exit
